...
export default function Footer() {
  const WHATSAPP_LINK = "https://wa.me/4917680480774?text=ITALIEN";
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 mb-8 border-b border-slate-800 pb-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li>
              WhatsApp: <a href={WHATSAPP_LINK} className="text-brand-green hover:text-white transition-colors">017680480774</a>
            </li>
            <li>
